...
class TrafficLightNode(Node):
    ...
    def __init__(self):
        ...
        params.minArea = 50  # Permitimos ver colores desde lejos
    ...
    def camera_callback(self, msg):
        ...
        mask_yellow = cv.inRange(hsv, np.array([10, 30, 80]), np.array([35, 255, 255]))
        ...
        # -------------------------------------------------------
        UMBRAL_TAMANO_LUZ_30CM = 80.0
        # -------------------------------------------------------

        letra_final = "N" # Por defecto, si está lejos, enviamos "N"
        
        # SI el tamaño del blob es mayor a nuestro umbral, significa que ya llegamos a 30cm
        if tamano_maximo > UMBRAL_TAMANO_LUZ_30CM:
